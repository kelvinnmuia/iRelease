...
export function SirsTypeChart() {
  ...
  const [hasDataInDexie, setHasDataInDexie] = useState<boolean | null>(null)
      ...
      <Card className="h-full">
        ...
        <CardContent className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-gray-500 mt-2">Checking for SIRs data...</p>
          </div>
        </CardContent>
      </Card>
    )
      ...
      <Card className="h-full">
        ...
        <CardContent className="flex items-center justify-center h-64">
          <div className="text-center text-gray-500">
            ...
            <p className="text-gray-500 font-medium">No SIRs releases data available</p>
