    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto">
          <div className="p-3 sm:p-4 md:p-6 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {/* Main content area */}
            <div className="md:col-span-2 lg:col-span-3 space-y-3 sm:space-y-4 md:space-y-6">
              <StatsCards />
