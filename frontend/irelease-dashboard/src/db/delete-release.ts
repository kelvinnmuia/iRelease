 ...
 */
function makeJsonpDeleteRequest<T = JsonpResponse>(releaseId: string): Promise<T> {
 ...
 */
export async function deleteRelease(releaseId: string): Promise<JsonpResponse> {
  try {
    ...
    const result = await makeJsonpDeleteRequest<JsonpResponse>(releaseId);
 ...
 */
export async function deleteReleaseFromFrontendData(frontendReleaseData: any): Promise<JsonpResponse> {
