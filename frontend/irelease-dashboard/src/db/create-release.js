 ...
 */
function makeJsonpPostRequest(endpoint, data) {
...
export async function createRelease(releaseData) {
    try {
        ...
        const result = await makeJsonpPostRequest('/api/releases', releaseData);
 ...
 */
export function transformToBackendFormat(formData) {
    const transformed = {};
    const fieldMappings = {
 ...
 */
export async function createReleaseFromForm(formData) {
