...
const transformSirReleaseForExport = (sir_release_data, visibleColumns) => {
    const exportData = {};
...
export const exportToCSV = (data, visibleColumns, selectedRows) => {
    try {
        ...
        const filteredDataForExport = dataToExport.map(sir_release_data => transformSirReleaseForExport(sir_release_data, visibleColumns));
...
export const exportSingleSirRelease = (sir_release_data) => {
    try {
